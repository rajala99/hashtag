                    ...
                    <div className='page_one'>
                        <form onSubmit={(e) => handleSubmit(e)}>
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="password" class="form-control" placeholder="Password"  value={userPass} aria-label="Username" aria-describedby="addon-wrapping" id='txtpass' onChange={(e) => setUserPass(e.target.value)} required />
